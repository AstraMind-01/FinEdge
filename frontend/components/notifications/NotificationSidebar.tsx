  ...
  return (
    <div className="flex flex-col gap-6 w-full lg:w-[320px] shrink-0">
      ...
      <div className="bg-surface-container-low rounded-xl border border-white/5 p-5 shadow-sm">
        ...
        <ToggleSwitch checked={dndEnabled} onChange={() => setDndEnabled(!dndEnabled)} label="Enable DND" />
        
        {dndEnabled && (
          <div className="mt-4 p-3 bg-surface-container-high rounded-lg flex items-center justify-between text-[13px] text-on-surface border border-white/5">
            <span>10:00 PM</span>
      ...
      <div className="bg-surface-container-low rounded-xl border border-white/5 p-5 shadow-sm">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-[13px] text-on-surface font-medium">New device login</p>
              <p className="text-[12px] text-on-surface-variant">Chrome on Mac OS • 2 hours ago</p>
            </div>
          </div>
          <div className="flex gap-3">
            <div className="w-2 h-2 rounded-full bg-surface-container-highest border border-on-surface-variant mt-1.5 shrink-0" />
            <div>
              <p className="text-[13px] text-on-surface-variant">Password changed</p>
              <p className="text-[12px] text-on-surface-variant/70">Last month</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Contact Support */}
      <div className="bg-gradient-to-br from-primary/20 to-surface-container-low rounded-xl border border-primary/20 p-5 shadow-sm relative overflow-hidden group cursor-pointer hover:border-primary/40 transition-all">
