...
export default function DepositsHeader({ onOpenNewDeposit }: DepositsHeaderProps) {
  return (
    <div className="pt-4 pb-8 flex flex-col gap-6 relative z-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <button 
          ...
          className="group flex items-center justify-center gap-2 px-6 py-3 rounded-lg border border-primary text-on-primary bg-primary hover:bg-primary-fixed hover:shadow-[0_0_20px_rgba(240,180,41,0.4)] transition-all duration-300 relative overflow-hidden"
        >
