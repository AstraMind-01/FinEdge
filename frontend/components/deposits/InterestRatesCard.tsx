...
export default function InterestRatesCard() {
  const rates = [
  ...
  return (
    <div className="bg-surface-container rounded-xl border border-surface-container-highest overflow-hidden shadow-lg p-6">
      ...
      <button className="w-full mt-6 flex items-center justify-center gap-2 text-primary font-semibold text-sm hover:text-primary-fixed transition-colors">
        Calculate Returns
        <ArrowRight size={16} />
      </button>
    </div>
