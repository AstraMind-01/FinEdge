...
interface DepositSummaryProps {
  onViewDetails?: (type: 'FD' | 'RD') => void;
  deposits?: Deposit[];
}

export default function DepositSummary({ onViewDetails, deposits: propDeposits }: DepositSummaryProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
      ...
      <div 
        ...
        className="bg-surface-container rounded-xl border border-surface-container-highest p-5 group hover:border-outline-variant transition-colors cursor-pointer"
      >
        <div className="flex justify-between items-start mb-4">
