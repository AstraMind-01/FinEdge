...
import AccountOpeningWizardModal from "./AccountOpeningWizardModal";
        ...
        <div className="flex flex-col gap-4 text-xs">
          ...
          <div className="flex justify-end gap-3 pt-3 border-t border-outline-variant/20 mt-2">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-primary text-on-primary hover:shadow-[0_0_15px_rgba(240,180,41,0.4)] font-medium rounded-xl text-sm transition-all flex items-center gap-2 cursor-pointer"
            >
