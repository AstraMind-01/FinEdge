  ...
  return (
    <div className="lg:col-span-5 bg-surface-container rounded-xl p-6 shadow-sm border border-white/5 flex flex-col h-full">
      <div className="flex justify-between items-center mb-4">
        ...
        <a className="text-[12px] text-primary hover:underline font-medium" href="#!">View All</a>
      </div>
      ...
      <div className="flex flex-col gap-3 flex-1 overflow-y-auto max-h-[300px] pr-2">
        {isLoading ? (
          ...
          transactions.map(tx => (
            <div key={tx.id} className="grid grid-cols-[40px_1fr_auto] items-center gap-4 group cursor-pointer p-2 -mx-2 rounded-lg hover:bg-surface-high transition-colors">
