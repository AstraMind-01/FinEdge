    ...
    <div className="pt-4 pb-8 flex flex-col gap-6 relative z-10">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-2">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto overflow-x-auto pb-1 sm:pb-0 scrollbar-hide">
          <button className="px-4 py-2 rounded-lg bg-primary/10 text-primary border border-primary/20 text-sm font-semibold whitespace-nowrap">All</button>
          <button className="px-4 py-2 rounded-lg bg-surface-container border border-surface-container-highest text-on-surface-variant hover:text-on-surface hover:border-outline-variant transition-colors text-sm font-medium whitespace-nowrap">Domestic</button>
          <button className="px-4 py-2 rounded-lg bg-surface-container border border-surface-container-highest text-on-surface-variant hover:text-on-surface hover:border-outline-variant transition-colors text-sm font-medium whitespace-nowrap">International</button>
          <button className="px-4 py-2 rounded-lg bg-surface-container border border-surface-container-highest text-on-surface-variant hover:text-on-surface hover:border-outline-variant transition-colors text-sm font-medium ml-auto flex items-center gap-2">
            <Filter size={16} />
            More Filters
          </button>
        </div>
