    ...
    <section className="relative w-full rounded-2xl overflow-hidden shadow-xl group">
      ...
      <div className="relative z-20 flex flex-col p-6 lg:p-8 gap-6 h-full justify-end">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-2">
          <div className="bg-surface/60 backdrop-blur-md p-4 rounded-xl border border-white/5 hover:border-primary/50 transition-colors cursor-pointer group/tile flex flex-col items-center text-center gap-2">
