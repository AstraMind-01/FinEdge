...
import DeepDiveModal, { DeepDiveReportType } from '../modals/DeepDiveModal';
...
export default function DeepDiveTiles() {
  const [selectedReport, setSelectedReport] = useState<DeepDiveReportType | null>(null);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          {TILES.map((tile) => {
            ...
            return (
              <div
                key={tile.label}
                onClick={() => setSelectedReport({ title: tile.label, desc: tile.desc, category: tile.category })}
